...
CREATE OR ALTER PROCEDURE dbo.LST_TB_RELATORIO_MODELO_SAIDA
...
BEGIN TRY
		...
		SET @selectColumns = 'select a.COD_MODELO_SAIDA, a.COD_RELATORIO_MODELO, a.NM_ABA_ARQUIVO, a.DS_SAIDA, a.NR_ORDEM, a.FL_ATIVO, a.DT_CRIACAO '
...
END
	  ...
	  , @qtd = @p_TOTAL_REGISTERS OUTPUT
		...
		SET @sql = @selectColumns + @sqlFromWhere + Program.dbo.FNC_BUILD_OFFSET_PAGE('a.COD_MODELO_SAIDA', @p_PAGE_NUMBER, @p_PAGE_SIZE)
...
GO
 ...
 --EXEC LST_TB_RELATORIO_MODELO_SAIDA @p_Filter = 'COD_MODELO_SAIDA:Maior que:0', @p_PageNumber = 1
