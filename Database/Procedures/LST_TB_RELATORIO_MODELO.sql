...
CREATE OR ALTER PROCEDURE dbo.LST_TB_RELATORIO_MODELO
...
BEGIN TRY
		...
		SET @selectColumns = 'select a.COD_RELATORIO_MODELO, a.NM_MODELO, a.DS_MODELO, a.NM_PROCEDURE, a.TP_ARQUIVO_PADRAO, a.COD_CATEGORIA, a.FL_ATIVO, a.QT_MAX_TENTATIVAS, a.QT_TIMEOUT_MINUTOS, a.DT_CRIACAO, a.COD_USUARIO_CRIACAO, a.DT_ALTERACAO, a.COD_USUARIO_ALTERACAO '
...
END
	  ...
	  , @qtd = @p_TOTAL_REGISTERS OUTPUT
		...
		SET @sql = @selectColumns + @sqlFromWhere + Program.dbo.FNC_BUILD_OFFSET_PAGE('a.COD_RELATORIO_MODELO', @p_PAGE_NUMBER, @p_PAGE_SIZE)
...
GO
 ...
 --EXEC LST_TB_RELATORIO_MODELO @p_Filter = 'COD_RELATORIO_MODELO:Maior que:0', @p_PageNumber = 1
