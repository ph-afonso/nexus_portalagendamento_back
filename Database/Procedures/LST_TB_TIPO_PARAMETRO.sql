...
CREATE OR ALTER PROCEDURE dbo.LST_TB_TIPO_PARAMETRO
...
BEGIN TRY
		...
		SET @selectColumns = 'select a.COD_TIPO_PARAMETRO, a.DS_TIPO, a.DS_VALIDACAO_REGEX, a.FL_OBRIGATORIO_PADRAO, a.SIT_ATIVO '
...
END
	  ...
	  , @qtd = @p_TOTAL_REGISTERS OUTPUT
		...
		SET @sql = @selectColumns + @sqlFromWhere + Program.dbo.FNC_BUILD_OFFSET_PAGE('a.COD_TIPO_PARAMETRO', @p_PAGE_NUMBER, @p_PAGE_SIZE)
...
GO
 ...
 --EXEC LST_TB_TIPO_PARAMETRO @p_Filter = 'COD_TIPO_PARAMETRO:Maior que:0', @p_PageNumber = 1
