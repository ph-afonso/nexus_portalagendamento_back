...
CREATE OR ALTER PROCEDURE dbo.LST_TB_RELATORIO_LOG
...
BEGIN TRY
		...
		SET @selectColumns = 'select a.COD_LOG, a.COD_RELATORIO_SOLICITACAO, a.DT_LOG, a.DS_EVENTO, a.DS_DETALHES, a.QT_TEMPO_EXECUCAO_MS '
...
END
	  ...
	  , @qtd = @p_TOTAL_REGISTERS OUTPUT
		...
		SET @sql = @selectColumns + @sqlFromWhere + Program.dbo.FNC_BUILD_OFFSET_PAGE('a.COD_LOG', @p_PAGE_NUMBER, @p_PAGE_SIZE)
...
GO
 ...
 --EXEC LST_TB_RELATORIO_LOG @p_Filter = 'COD_LOG:Maior que:0', @p_PageNumber = 1
