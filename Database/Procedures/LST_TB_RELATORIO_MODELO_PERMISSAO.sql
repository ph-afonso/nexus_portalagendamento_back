...
CREATE OR ALTER PROCEDURE dbo.LST_TB_RELATORIO_MODELO_PERMISSAO
...
BEGIN TRY
		...
		SET @selectColumns = 'select a.COD_PERMISSAO, a.COD_RELATORIO_MODELO, a.COD_USUARIO, a.COD_PERFIL, a.COD_DEPARTAMENTO, a.FL_PODE_EXECUTAR, a.FL_PODE_VISUALIZAR, a.FL_PODE_BAIXAR, a.DT_CRIACAO '
...
END
	  ...
	  , @qtd = @p_TOTAL_REGISTERS OUTPUT
		...
		SET @sql = @selectColumns + @sqlFromWhere + Program.dbo.FNC_BUILD_OFFSET_PAGE('a.COD_PERMISSAO', @p_PAGE_NUMBER, @p_PAGE_SIZE)
...
GO
 ...
 --EXEC LST_TB_RELATORIO_MODELO_PERMISSAO @p_Filter = 'COD_PERMISSAO:Maior que:0', @p_PageNumber = 1
