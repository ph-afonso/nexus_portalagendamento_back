...
CREATE OR ALTER PROCEDURE dbo.LST_TB_STATUS_PROCESSAMENTO
...
BEGIN TRY
		...
		SET @selectColumns = 'select a.COD_STATUS_PROCESSAMENTO, a.DS_STATUS, a.SIT_ATIVO, a.DT_CRIACAO '
...
END
	  ...
	  , @qtd = @p_TOTAL_REGISTERS OUTPUT
		...
		SET @sql = @selectColumns + @sqlFromWhere + Program.dbo.FNC_BUILD_OFFSET_PAGE('a.COD_STATUS_PROCESSAMENTO', @p_PAGE_NUMBER, @p_PAGE_SIZE)
...
GO
 ...
 --EXEC LST_TB_STATUS_PROCESSAMENTO @p_Filter = 'COD_STATUS_PROCESSAMENTO:Maior que:0', @p_PageNumber = 1
