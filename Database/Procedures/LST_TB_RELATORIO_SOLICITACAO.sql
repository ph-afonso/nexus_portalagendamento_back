...
CREATE OR ALTER PROCEDURE dbo.LST_TB_RELATORIO_SOLICITACAO
...
BEGIN TRY
		...
		SET @selectColumns = 'select a.COD_RELATORIO_SOLICITACAO, a.COD_RELATORIO_MODELO, a.COD_USUARIO, a.DS_PARAMETROS, a.COD_STATUS_PROCESSAMENTO, a.DT_CRIACAO, a.DT_INICIO_PROCESSAMENTO, a.DT_FIM_PROCESSAMENTO, a.URL_ARQUIVO, a.NM_ARQUIVO, a.TP_ARQUIVO, a.MSG_ERRO, a.QT_TENTATIVAS, a.FL_NOTIFICADO, a.COD_JOB_EXTERNO, a.QT_REGISTROS_GERADOS, a.QT_TAMANHO_ARQUIVO_KB, a.NM_PROCEDURE_AD_HOC, a.TP_ARQUIVO_SOLICITADO, a.DS_LAYOUT_SAIDA_JSON '
...
END
	  ...
	  , @qtd = @p_TOTAL_REGISTERS OUTPUT
		...
		SET @sql = @selectColumns + @sqlFromWhere + Program.dbo.FNC_BUILD_OFFSET_PAGE('a.COD_RELATORIO_SOLICITACAO', @p_PAGE_NUMBER, @p_PAGE_SIZE)
...
GO
 ...
 --EXEC LST_TB_RELATORIO_SOLICITACAO @p_Filter = 'COD_RELATORIO_SOLICITACAO:Maior que:0', @p_PageNumber = 1
