...
CREATE OR ALTER PROCEDURE dbo.LST_TB_RELATORIO_DESTINO_TIPO
...
BEGIN TRY
		...
		SET @selectColumns = 'select a.COD_DESTINO_TIPO, a.NM_TIPO, a.DS_TIPO, a.FL_ATIVO '
...
END
	  ...
	  , @qtd = @p_TOTAL_REGISTERS OUTPUT
		...
		SET @sql = @selectColumns + @sqlFromWhere + Program.dbo.FNC_BUILD_OFFSET_PAGE('a.COD_DESTINO_TIPO', @p_PAGE_NUMBER, @p_PAGE_SIZE)
...
GO
 ...
 --EXEC LST_TB_RELATORIO_DESTINO_TIPO @p_Filter = 'COD_DESTINO_TIPO:Maior que:0', @p_PageNumber = 1
