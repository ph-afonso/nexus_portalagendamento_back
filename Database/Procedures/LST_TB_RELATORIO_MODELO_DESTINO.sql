...
CREATE OR ALTER PROCEDURE dbo.LST_TB_RELATORIO_MODELO_DESTINO
...
BEGIN TRY
		...
		SET @selectColumns = 'select a.COD_MODELO_DESTINO, a.COD_RELATORIO_MODELO, a.COD_DESTINO_TIPO, a.FL_NOTIFICAR_SOLICITANTE, a.DS_CONFIGURACAO_JSON, a.FL_ANEXAR_ARQUIVO, a.FL_ATIVO '
...
END
	  ...
	  , @qtd = @p_TOTAL_REGISTERS OUTPUT
		...
		SET @sql = @selectColumns + @sqlFromWhere + Program.dbo.FNC_BUILD_OFFSET_PAGE('a.COD_MODELO_DESTINO', @p_PAGE_NUMBER, @p_PAGE_SIZE)
...
GO
 ...
 --EXEC LST_TB_RELATORIO_MODELO_DESTINO @p_Filter = 'COD_MODELO_DESTINO:Maior que:0', @p_PageNumber = 1
